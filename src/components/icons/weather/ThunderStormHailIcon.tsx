...
interface ThunderStormHailIconProps extends WheaterIconProps {}

const ThunderStormHailIcon: FC<ThunderStormHailIconProps> = ({pathStroke, w = 48, h = 50}) => (
