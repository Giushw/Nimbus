...
interface FreezeDrizzleIconProps {
  pathStroke: string,
  w?: number,
  h?: number
}

const FreezeDrizzleIcon: FC<FreezeDrizzleIconProps> = ({pathStroke, w, h}) => (
    <Icon viewBox='0 0 48 43' fill="none" width={w ?? 48} height={h ?? 43} stroke={pathStroke}>
      <path
